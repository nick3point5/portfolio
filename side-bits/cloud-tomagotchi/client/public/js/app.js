class interObj {
  ...
  function uiUpdate() {
    ...
    mesEl.text(`${pet.name} is ${pet.currentState}`)
  }
  ...
  function Init() {
    ...
    if(pet.width === 0 || pet.height === 0){
      pet.owid = $("#pet")[0].clientWidth
      pet.ohei = $("#pet")[0].clientHeight
      pet.xmax = playwin.width - pet.owid;
      pet.ymax = playwin.height - pet.ohei;
  ...
  const playwin = window.playwin
  
  $("#name")[0].value = 'Korby'
  
  window.pet = new petClass(
    0,
    530,
    $("#pet")[0].clientWidth,
    $("#pet")[0].clientHeight,
