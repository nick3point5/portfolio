...
// Print the array of Jupiter's moons to the console (no for loop, just print
// the entire array).
    console.log(
        solarSystem[4].moons
    )
...
// "Charon").
    ...
    Object.assign(solarSystem[2], {'diameter': '7917.5 mi'})
    ...
    // ringSystem (where ringSystem: true), and ignore the others. You want to make a
    // loop that goes over each item in the array, and include an if statement.
...
// console.log the sum of the number of satellites of Jupiter, Saturn, Uranus,
// and Neptune (131)
console.log(
    system.Jupiter.satellites+system.Saturn.satellites+system.Uranus.satellites+system.Neptune.satellites
)
// Write a conditional that checks if Mercury's radiusp is a string (remember
// the typeof command). If Mercury's radiusp is a string, change the value to be
// the same as its radiuse value. (radiusp is radius at the poles, radiuse is
...
// Find the difference between Jupiter's momentum and Pluto's momentum. (To get
// momentum, you'll want the product of velocity and mass).
console.log(
system.Jupiter.mass*system.Jupiter.velocity-system.Pluto.mass*system.Pluto.velocity
)

// Outside of any of these predefined solar system objects, make your own object
// called PlanetX. Give PlanetX the same properties as a planet within system (eg.
// density, tilt, mass) and give it made-up values.
PlanetX={ 
    radiusp: 'same',
    name: 'PlanetX',
    density: 10,
...
// include planetX as a property of system. (Your planetX object is a planet within
// the system).
    Object.assign(system, {PlanetX})

// When you console.log(system), planetX should be appear as a planet in the
// system.
